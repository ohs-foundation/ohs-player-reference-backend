"""Posts a CSV to POST /api/bulk-import/organizations and reports timing/throughput.

Rows are processed in FHIR BATCH bundles; the server continues past row
errors and always emits a terminal `done` event with true processed/failed/total.
"""
...
ENDPOINT_PATH = "/api/bulk-import/organizations"
